...
export const metadata = {
  title: "Produit introuvable - Administration",
};
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Produit introuvable</h1>
            <p className="text-gray-600">Erreur d&apos;administration - Produit non trouvé</p>
          </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">
                    Produit non trouvé dans le système
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Le produit que vous tentez de modifier n&apos;existe pas dans notre base de données
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-pink-500 rounded-full mt-2 flex-shrink-0"></span>
                        Confirmez que le produit n&apos;a pas été supprimé récemment
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-pink-500 rounded-full mt-2 flex-shrink-0"></span>
