export const ROUTES={
    ...
    DASHBOARD_CREATE_SUPPLIERS:"/dashboard/suppliers/create",
    DASHBOARD_UPDATE_SUPPLIERS:"/dashboard/suppliers/update",
    DASHBOARD_SUPPLIERS_ORDERS:"/dashboard/suppliers/orders",
    DASHBOARD_SUPPLIERS_ORDER_DETAIL:(id: number) => `/dashboard/suppliers/orders/${id}`,
    DASHBOARD_CREATE_SUPPLIERS_ORDER:"/dashboard/suppliers/orders/create",
